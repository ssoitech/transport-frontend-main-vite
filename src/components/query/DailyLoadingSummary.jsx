...
function DailyLoadingSummary() {
  ...
  async function postFilteredData(data, page) {
    const searchedData = {
      loadingDate: data.permitFromDate
  ...
  const handleDownload = () => {
    ...
    if (excelBlob) {
      saveAs(excelBlob, "daily_loading_summary.xlsx");
    ...
    <>
      <div className="work-space-container">
        <div
          ...
          role="alert"
        >
          <span className="mb-0 h6">Daily Loading Summary</span>
        </div>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-row">
            <div className="form-group col-sm-2 ml-4">
              <label htmlFor="inputField3">Report Date</label>
              <Controller
                control={control}
                name="permitFromDate"
                render={({ field }) => (
              ...
              <table className="table table-bordered table-hover">
                <thead className="thead-dark">
                  <tr className="p-1 text-center">
                    ...
                    <th>Material</th>
                    <th>Vehicle Rate</th>
                    <th>Permit Quantity</th>
                    <th>Today's Lifting</th>
                    <th>Cumulative Lifting</th>
                    <th>Balance Qty</th>
                    <th>Velide Till</th>
                    <th>Remark</th>
                    <th>Booking Rate</th>
...
export default DailyLoadingSummary;
