...
const handleExportClick = () => {
  ...
  const handleDownload = () => {
    if (excelBlob) {
      saveAs(excelBlob, "own_and_discounted_challan.xlsx");
    ...
    <>
      <div className="work-space-container">
        <div
          ...
          role="alert"
        >
          <span className="mb-0 h6">Own & Discounted Challan</span>
        </div>
          ...
          <div className="form-row">
            <div className="form-group col-md-4 align-self-center">
              <div className="text-center">
                {" "}
                <label htmlFor="inputField3">Challan Receive Date</label>
              </div>
    ...
    <table className="table table-bordered table-hover">
      <thead className="thead-dark">
        <tr className="p-1 text-center">
          ...
          <th>From Mines/Consignor</th>
          <th>To Exporter/Consingnee</th>
          <th>Posting</th>
          <th>Posted By</th>
        </tr>
      </thead>
