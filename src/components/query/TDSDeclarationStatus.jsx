      ...
      <div className="work-space-container">
        ...
        >
          <span className="mb-0 h6">
            TDS Declaration Status(Every Year Should be Re-newed)
          </span>
        </div>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-row">
            <div className="form-group col-md-2">
              <label htmlFor="consignor">Display Order By</label>
            ...
            <div className="form-group col-md-2">
              <label htmlFor="consignor">TDS Status</label>
...
export default TDSDeclarationStatus;
