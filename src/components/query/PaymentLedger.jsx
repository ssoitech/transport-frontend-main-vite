...
function PaymentLedger() {
  ...
  async function postFilteredData(data, page) {
    const searchedData = {
      challanHolder: data.challanHolder ? data.challanHolder : null,
    ...
    <>
      <div className="work-space-container">
        <div
          ...
          role="alert"
        >
          <span className="mb-0 h6">Payment Ledger</span>
        </div>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-row">
            <div className="form-group col-md-4">
              <label htmlFor="permitNo">Challan Holder</label>
              <input
                type="text"
                {...register("challanHolder")}
                className="form-control form-control-sm border-dark-subtle"
                id="challanHolder"
              />
            </div>
            <div className="form-group col-md-3">
              <label htmlFor="permitNo">PAN</label>
              <input
                type="text"
                {...register("pan")}
                className="form-control form-control-sm border-dark-subtle"
            ...
            <div className="form-group col-md-3">
              <label htmlFor="permitNo">Contact No.</label>
              <input
                type="text"
                {...register("contactNo")}
                className="form-control form-control-sm border-dark-subtle"
          ...
          <div className="form-row">
            <div className="form-group col-md-4 align-self-center">
              <div className="text-center">
                {" "}
                <label htmlFor="inputField3">Report Period</label>
              </div>
