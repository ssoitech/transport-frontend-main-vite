...
import VehicleRateForPayment from '../challanInput/permitMasterSection/VehicleRateForPayment';
import ShortageCalculation from '../challanInput/permitMasterSection/ShortageCalculation';
        ...
        <div className='work-space-container'>
            ...
            <div className='container mb-2'>
                <div className='text-center'>
                    <button type="button" className="m-2 btn btn-primary" onClick={(e) => { handleClear(e) }}>New Permit</button>
