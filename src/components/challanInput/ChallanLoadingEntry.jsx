...
function ChallanLoadingEntry() {
  ...
  const [challanFindButtonDesabled, setChallanFindButtonDesabled] =
    useState(false);
  ...
  useEffect(() => {
    if (data) {
      setValidFomDate(
        data.validFrom ? format(data.validFrom, "d-MMM-yyyy") : ""
      );
  ...
  async function getAllFieldStaffNames() {
    await axiosInstance
      .get("/api/v1/get/all/field-staff-master")
  ...
  async function getAllBrokersName() {
    await axiosInstance
      .get("/api/v1/get/all/fleet-agent-broker-master")
      .then(function (response) {
        // handle success
  ...
  async function getAllFillingStationsName() {
    await axiosInstance
      .get("/api/v1/get/filling-stations")
      .then(function (response) {
        // handle success
  ...
  async function getData(permitNum) {
    await axiosInstance
      .get(`/api/v1/get/iform/get-specific-details/${permitNum}`)
      .then(function (response) {
        setIsSearching(false);
        // handle success
  ...
  async function postData(fdata) {
    await axiosInstance
      .post("/api/v1/add/one/challan", fdata)
  ...
  const onSubmit = async (formData) => {
    ...
    const challanData = {
      ...
      petrolRate: formData.petrolRate ? formData.petrolRate : 0.0,
      rate: formData.rate ? formData.rate : 0.0,
      issueSlip: formData.issueSlip,
      hsdIssued: formData.hsdIssued ? formData.hsdIssued : 0.0,
      hsdAdvance: formData.hsdAdvance ? formData.hsdAdvance : 0.0,
      cashAdvance: formData.cashAdvance ? formData.cashAdvance : 0.0,
  ...
  useEffect(() => {
    if (dataFromChallanNumber) {
      ...
      if (dataFromChallanNumber.vehicleOwner) {
        setVehicleOwner(
          dataFromChallanNumber.vehicleOwner
            ? dataFromChallanNumber.vehicleOwner
            : null
        );
        ...
        setVehicleOwner(
          truckData[0].truckOwner ? truckData[0].truckOwner : null
        );
        setVehicleOwnerId(truckData[0].ownerId ? truckData[0].ownerId : null);
      }
      ...
      if (dataFromChallanNumber.challanMasterOfficeExpense) {
        setValue(
          "officeExpenses",
          dataFromChallanNumber.challanMasterOfficeExpense
        );
      } else if (shortageCalculationData.oerAmount) {
        try {
          let offliceExp = dataFromChallanNumber.loadWeight
            ? parseFloat(
                shortageCalculationData.oerAmount *
                  dataFromChallanNumber.loadWeight
              ).toFixed(2)
            : 0;
        ...
        if (truckData[0].truckWheelType) {
          ...
          switch (truckWheelNumber) {
            case "6":
              setValue(
                "officeExpenses",
                shortageCalculationData ? shortageCalculationData.oer6wheel : 0
              );
              break;
            case "8":
              setValue(
                "officeExpenses",
                shortageCalculationData ? shortageCalculationData.oer8wheel : 0
              );
              break;
            case "10":
              setValue(
                "officeExpenses",
                shortageCalculationData ? shortageCalculationData.oer10wheel : 0
              );
              break;
            case "12":
              setValue(
                "officeExpenses",
                shortageCalculationData ? shortageCalculationData.oer12wheel : 0
              );
              break;
            case "14":
              setValue(
                "officeExpenses",
                shortageCalculationData ? shortageCalculationData.oer14wheel : 0
              );
              break;
            case "16":
              setValue(
                "officeExpenses",
                shortageCalculationData ? shortageCalculationData.oer16wheel : 0
              );
              break;
            case "18":
              setValue(
                "officeExpenses",
                shortageCalculationData ? shortageCalculationData.oer18wheel : 0
              );
              break;
            case "22":
              setValue(
                "officeExpenses",
                shortageCalculationData ? shortageCalculationData.oer22wheel : 0
              );
              break;
            default:
  ...
  async function getDataByChallanNo(challanNum, permitNum) {
    await axiosInstance
      .get(`/api/v1/get/one/challan-details/${challanNum}/${permitNum}`)
      .then(function (response) {
        // handle success
  ...
  async function getDataByTpNumber(tpNum) {
    await axiosInstance
      .get(`/api/v1/get/one/challan-details/bytpnumber/${tpNum}`)
      .then(function (response) {
        // handle success
        console.log(response.data);
  ...
  const fetchSuggestions = async (query) => {
    try {
      await axiosInstance
        .get(`/api/v1/challan-holder/get/all/names-ids?keyword=${query}`)
        .then(function (response) {
          console.log(response.data);
      ...
      <div>
        <form id="challanForm" onSubmit={handleSubmit(onSubmit)}>
          <div className="grid-section1">
            <div className="item1">
              <div className="">
                <label for="permitNumber" className="form-label">
                  Permit Number
                </label>
            ...
            <div className="item1">
              <div className="">
                <label for="stackNo" className="form-label">
                  Stack No
                </label>
                <div className="">
                  {stackData ? (
            ...
            <div className="item1">
              <div className="">
                <label for="validFrom" className="form-label">
                  Valid From
                </label>
                <div className="">
                  <DatePicker
            ...
            <div className="item1">
              <div className="">
                <label for="validTo" className="form-label">
                  Valid To
                </label>
                <div className="">
                  <DatePicker
          ...
          <div className="grid-container card">
            <div className="item">
              <div className="">
                <label for="consignerName" className="form-label">
                  Mines/Consigner Name
                </label>
                <div className="">
                  <input
                    type="text"
            ...
            <div className="item">
              <div className="">
                <label for="exporterName" className="form-label">
                  Exporter/Consignee Name
                </label>
                <div className="">
                  <input
                    type="text"
            ...
            <div className="item">
              <div className="">
                <label for="loadingPoint" className="form-label">
                  Loading Point
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="unloadingPoint" className="form-label">
                  Un-Loading Point
                </label>
                <div className="">
                  <input
          ...
          <div className="grid-container2">
            <div className="item">
              <div className="">
                <label for="vehicleRate" className="form-label">
                  Vehicle Rate
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="paymentRate" className="form-label">
                  Payment Rate
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="officeExpenses" className="form-label">
                  Office Expenses <span>{"( Deduction on Final Payment)"}</span>
                </label>
                <div className="">
                  <input
                    type="number"
            ...
            <div className="item">
              <div className="">
                <label for="loadDate" className="form-label">
                  Load Date
                </label>
                <div className="">
                  <DatePicker
            ...
            <div className="item">
              <div className="">
                <label for="truckNumber" className="form-label">
                  Truck Number
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="truckType" className="form-label">
                  Truck Type<span>{"(Union/Non-Union)"}</span>{" "}
                </label>
                <div className="">
                  <div className="">
                    <select
            ...
            <div className="item">
              <div className="">
                <label for="challanNumber" className="form-label">
                  Challan Number
                </label>
                <div className="row">
                  <div className="col-auto">
                  ...
                  <div className="col-auto">
                    <button
                      type="button"
                      className="btn btn-sm btn-primary mb-3 w-100"
                      disabled={challanFindButtonDesabled}
                      onClick={() => {
                        findChallan();
                      }}
            ...
            <div className="item">
              <div className="">
                <label for="tpNumber" className="form-label">
                  TP Number
                </label>
                <div className="row">
                  <div className="col-auto">
            ...
            <div className="item">
              <div className="">
                <label for="invNumber" className="form-label">
                  WS/Inv. Number
                </label>
                <div className="row">
                  <div className="col-auto">
            ...
            <div className="item">
              <div className="">
                <label for="loadingGross" className="form-label">
                  Loading Gross<span>{"(MT)"}</span>
                </label>
                <div className="">
                  <input
                    type="number"
            ...
            <div className="item">
              <div className="">
                <label for="loadingTare" className="form-label">
                  Loading Tare <span>{"(MT)"}</span>
                </label>
                <div className="">
                  <input
                    type="number"
            ...
            <div className="item">
              <div className="">
                <label for="loadingWeight" className="form-label">
                  Load Weight A <span>{"(MT)"}</span>
                </label>
                <div className="">
                  <input
                    type="number"
            ...
            <div className="item">
              <div className="">
                <label for="petrolPump" className="form-label">
                  Petrol Pump
                </label>
                <div className="row">
                  <div className="col-auto">
                      ...
                      >
                        ...
                        {allFillingStationsName.map((item, idx) => {
                          return (
                            <option
                              selected={
                                item.nameId === petrolPumpId ? true : false
                              }
                              key={idx}
                              value={item.nameId}
                            >
              ...
              <div className="">
                ...
                <div className="">
                  <input
                    type="number"
                    disabled={
                      Number(watch("petrolPump")) === 152 ? true : false
                    }
                    className="form-control form-control-sm custom-border w-75"
                    id="rate"
                    name="rate"
            ...
            <div className="item">
              <div className="">
                <label for="issueSlip" className="form-label">
                  Issue Slip
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="hsdIssued" className="form-label">
                  HSD Issued<span>{"(Ltr)"}</span>
                </label>
                <div className="">
                  <input
                    type="number"
            ...
            <div className="item">
              <div className="">
                <label for="hsdAdvance" className="form-label">
                  HSD Advance
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="cashAdvance" className="form-label">
                  Cash Advance <span>{"(Paid)"}</span>
                </label>
                <div className="">
                  <input
                    type="number"
            ...
            <div className="item">
              <div className="">
                <label for="fieldStaff" className="form-label">
                  Field Staff
                </label>
                <div className="">
                  <div className="">
                    {allFieldStaffNames ? (
                      ...
                      >
                        ...
                        {allFieldStaffNames.map((item, idx) => {
                          return (
                            <option
                              selected={item.id === fieldStaffId ? true : false}
                              key={idx}
                              value={item.id}
                            >
                              {item.name}
            ...
            <div className="item">
              <div className="">
                <label for="driverWelfare" className="form-label">
                  Driver Welfare <span>{"(Paid)"}</span>
                </label>
                <div className="">
                  <input
                    type="text"
            ...
            <div className="item">
              <div className="">
                <label for="challanAmount" className="form-label">
                  Challan Amount <span>{"(Collected)"}</span>
                </label>
                <div className="">
                  <input
                    type="number"
            ...
            <div className="item">
              <div className="">
                <label for="totalAdvance" className="form-label">
                  Total Advance
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="otherDeduction" className="form-label">
                  Other Deduction
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="deductionTowards" className="form-label">
                  Deduction Towards
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="truckDriver" className="form-label">
                  Truck Driver
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="dlNumber" className="form-label">
                  DL Number
                </label>
                <div className="">
                  <input
            ...
            <div className="item">
              <div className="">
                <label for="driverMobileNo" className="form-label">
            ...
            <div className="item" style={{ position: "relative" }}>
              {" "}
              {/* Relative container */}
              <label htmlFor="vehicleOwner" className="form-label">
                Vehicle Owner
              </label>
              <input
                type="text"
            ...
            <div className="item">
              <div className="">
                <label for="agent" className="form-label">
                  Agent / Broker
                </label>
                <div className="">
                  <div className="">
                    {allBrokersName ? (
                      ...
                      >
                        ...
                        {allBrokersName.map((item, idx) => {
                          return (
                            <option
                              selected={item.id === brokerId ? true : false}
                              key={idx}
                              value={item.id}
                            >
                              {item.name}
          ...
          <div className="button-container">
            <div className="button-item">
              <div class="row">
                <label htmlFor="entryBy" className="col-sm-4 col-form-label">
                  Entry By :
                </label>
              ...
              <div className="mb-1 row">
                <label htmlFor="entryDate" className="col-sm-4 col-form-label">
                  Entry Date :
                </label>
                <div className="col-sm-8">
                  <input
            ...
            <div className="button-item text-center">
              ...
              >
                {startSpneer && (
                  <div
                    className="spinner-border text-light spinner-border-sm pr-1"
                    role="status"
                  ></div>
                )}
                <span>Save</span>
