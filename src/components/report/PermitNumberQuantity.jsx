      ...
      <div className="work-space-container">
        ...
        >
          <span className="mb-0 h6">
            Consolidated On permit Number(Quantity)
          </span>
        </div>
            ...
            <table className="table table-striped table-bordered table-hover align-middle">
              <thead className="thead-dark">
                <tr className="text-center">
                  ...
                  <th scope="col">Billing Party</th>
                  <th scope="col">Permit Number</th>
                  <th scope="col">Despatched Challan</th>
                  <th scope="col">Despatched Quantity</th>
                  <th scope="col">Un-load Quantity</th>
                  <th scope="col">Difference Quantity</th>
                  <th scope="col">Shortage Quantity</th>
              ...
              <tbody className="font-weight-normal textColor">
                {ownerData.map((data, idx) => (
                  <tr key={idx}>
                    <td>{idx + 1}</td>
                    <td>{data.billingParty}</td>
                    <td>{data.permitNumber}</td>
                    <td>{data.despatchedChallan}</td>
                    <td>{data.despatchedQuantity}</td>
                    <td>{data.unLoadChallan}</td>
                    <td>{data.unLoadQuantity}</td>
                    <td>{data.differenceQuantity}</td>
                    <td>{data.shortageQuantity}</td>
                    <td>{data.receivedChallan}</td>
                    <td>{data.shortageAmount}</td>
...
export default PermitNumberQuantity;
