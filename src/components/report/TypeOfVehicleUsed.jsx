    ...
    <div>
      <div className="work-space-container">
        <div
          ...
          role="alert"
        >
          <span className="mb-0 h6">Report On Type of Vehicle</span>
        </div>
        <form>
          <div className="form-row">
            ...
            <div className="form-group col-md-4 align-self-center">
              <div className="text-center">
                {" "}
                <label htmlFor="inputField3">Challan Date</label>
              </div>
...
export default TypeOfVehicleUsed;
