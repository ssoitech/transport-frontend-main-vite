    ...
    <div>
      <div className="work-space-container">
        <div
          ...
          role="alert"
        >
          <span className="mb-0 h6">Truck-Wise Consolidated Freight</span>
        </div>
        ...
        <form>
          <div className="form-row">
            ...
            <div className="form-group col-md-2">
              <label htmlFor="consignor">Total Trip</label>
            ...
            <div className="form-group col-md-2">
              <label htmlFor="consignor">Total Fright</label>
            ...
            <div className="form-group col-md-2">
              <label htmlFor="consignor">Total TDS</label>
          ...
          <div className="form-row">
            <div className="form-group col-md-2">
              <label htmlFor="maxAmt">Maximum Amount</label>
...
export default TruckWiseFreight;
