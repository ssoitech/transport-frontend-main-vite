...
// needs to be changed
function PayableSummarytab({ billingParty, loadingPoint, destination, permitFromDate, permitToDate }) {
    ...
    <div>
      ...
      <div className="container mt-4">
        <div className="row align-items-center">
          ...
          <div className="col-sm-2 mb-2">
            {/* <button className="btn btn-sm btn-primary w-100" onClick={handleGetClick}>Date-Wise</button> */}
...
export default PayableSummarytab
